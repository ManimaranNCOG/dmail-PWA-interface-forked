  ...
  async function sendEmail(emailObject){
    ...
    if(publicKey && publicKey != "null"){
      ...
      if(encryptedMessage && isSameBlockChain){
        await sendEmailOnSameChain(emailObject, encryptedMessage, accounts, isSameHost, contactAddressFromName , userName , props);
      } else if (encryptedMessage){
        await sendEmailOnDifferentChain(emailObject , encryptedMessage , accounts , senderChainAddress , jsonValue , userName , props );
      }
